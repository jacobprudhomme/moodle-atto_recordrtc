...
if ($ADMIN->fulltree) {
    ...
    $default = '';
    $setting = new admin_setting_configtext('atto_recordrtc/serverurl', $name, $desc, $default, PARAM_URL, 20);
    $settings->add($setting);
    ...
    $default = '';
    $setting = new admin_setting_configtext('atto_recordrtc/apikey', $name, $desc, $default, PARAM_TEXT, 32);
    $settings->add($setting);
